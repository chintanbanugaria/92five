...
<title>92five app - {{$subject}} {{trans('92five.notFound')}} </title>
...
<div class="error_main">
    ...
    <div class="error_detail_1">{{$subject}} {{trans('92five.notFound')}} </div>
    <div class="error_detail_3">
    	<div class="error_detail_3_inner">
        	<p>{{trans('92five.the')}} {{$subject}} {{trans('92five.lookingForErrorText16')}}</p>
