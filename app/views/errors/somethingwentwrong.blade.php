...
<title>92five app - {{trans('92five.somethingWentWrong')}}</title>
...
<div class="error_main">
    ...
    <div class="error_detail_1">{{trans('92five.somethingWentWrong')}} </div>
    <div class="error_detail_3">
    	<div class="error_detail_3_inner">
        	<p>{{trans('92five.somethingWentWrongErrorText17')}}</p>
