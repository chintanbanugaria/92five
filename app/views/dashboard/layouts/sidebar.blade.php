      ...
      <div class="antiscroll-content">
        <div class="sidebar_inner">
          ...
          <div id="side_accordion" class="accordion">
            ...
            <div class="accordion-group bdr_none1">
              <div class="accordion-heading none_accrodion"> <a href="{{url('/dashboard/reports')}}"> <i class="accrod_icon"><img src="{{asset('assets/images/dashboard/reports.png')}}" alt=""></i>{{trans('92five.Reports')}} </a> </div>
            </div>
          </div>
        </div>
      </div>
